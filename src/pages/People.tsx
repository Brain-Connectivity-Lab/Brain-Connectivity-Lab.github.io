...
const GoogleScholarIcon = ({ size = 20, className = "" }) => (
  ...
  >
    ...
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12.0468 9.38992C10.7487 9.38992 9.53721 10.3703 9.53721 11.9168C9.53721 13.4357 10.7766 14.4162 12.0747 14.4162C13.3727 14.4162 14.5842 13.4357 14.5842 11.9168C14.5842 10.3703 13.3448 9.38992 12.0468 9.38992ZM12.0628 13.7845C11.1963 13.7845 10.4697 13.0298 10.4697 11.9168C10.4697 10.8322 11.2243 10.0215 12.0628 10.0215C12.9292 10.0215 13.6559 10.8039 13.6559 11.9168C13.6559 13.0016 12.9013 13.7845 12.0628 13.7845Z"
      fill="white"
    />
    <path
      d="M5.293 8.35122L12.0465 5L18.8 8.35122L12.0465 11.7024L5.293 8.35122Z"
      fill="white"
    />
    <rect
      x="17.6836"
      ...
      <div className="flex flex-wrap gap-3 mt-4 pt-4 border-t border-gray-700">
        {allLinks.map((link, linkIndex) => {
          ...
          if (link.type === "email") {
            ...
            buttonClass =
              "bg-[#0A66C2]/20 hover:bg-[#0A66C2]/30 border border-[#0A66C2]/40";
          } else if (link.type.includes("scholar")) {
            Icon = GoogleScholarIcon;
            buttonClass =
              "bg-[#4285F4]/10 hover:bg-[#4285F4]/20 border border-[#4285F4]/30";
          } else if (
            link.type.includes("portfolio") ||
            link.type.includes("website") ||
            link.type.includes("page")
          ) {
            Icon = Globe;
            iconClass = "text-green-400";
          } else if (
            link.type.includes("njit") ||
            link.type.includes("profile")
          ) {
            Icon = Building;
      ...
      members: [
        {
          ...
          links: [
            ...
            {
              title: "NJIT Board Profile",
              url: "https://www.njit.edu/boards/biswal",
            },
            {
              title: "Google Scholar",
              url: "https://scholar.google.com/citations?user=FJ8WWDYAAAAJ",
            },
          ],
        },
      ],
      ...
      members: [
        {
          ...
          links: [
            {
              title: "NJIT Profile",
              url: "https://people.njit.edu/profile/dixin",
            },
            { title: "Personal Website", url: "http://www.dixin.info/" },
            {
              title: "Google Scholar",
              url: "https://scholar.google.com/citations?user=wDjD46gAAAAJ",
            },
          ],
        },
      ],
      ...
      members: [
        {
          ...
          links: [
            {
              title: "LinkedIn",
              url: "https://www.linkedin.com/in/sukesh-kumar-das-1a819512/",
            },
            {
              title: "Personal Page",
              url: "https://sites.google.com/view/sukeshkumardas/home?pli=1",
            },
          ],
        },
        {
          ...
          links: [
            {
              title: "LinkedIn",
              url: "https://www.linkedin.com/in/priyankamittal-pm/",
            },
          ],
        },
        {
          name: "Dr. Sapna Mishra",
          role: "Postdoctoral Researcher",
          bio: "Dr. Mishra is a postdoctoral researcher working within a multimodal MRI framework integrating resting-state fMRI and diffusion MRI. She completed her PhD at IIT Delhi, where she developed a strong foundation in neuroimaging and computational methodologies. Her research focuses on developing and applying advanced computational methods to characterize large-scale brain networks and their microstructural underpinnings across diverse populations and conditions. With a background in machine learning, she aims to advance data-driven, network-based models of human brain organization by leveraging the complementary strengths of functional and diffusion imaging.",
          email: "ssm249@njit.edu",
          image: "/images/sapna.png",
          specialization:
            "Multimodal MRI, Diffusion MRI, Brain Networks, Machine Learning",
          links: [
            {
              title: "Google Scholar",
              url: "https://scholar.google.com/citations?user=7kSjjvgAAAAJ&hl=en",
            },
            {
              title: "LinkedIn",
              url: "https://www.linkedin.com/in/sapna-mishra-0a378653",
            },
          ],
        },
      ],
      ...
      members: [
        ...
        },
        {
          ...
          links: [
            {
              title: "LinkedIn",
              url: "https://www.linkedin.com/in/pratik-jain5/",
            },
          ],
        },
      ],
      ...
      members: [
        {
          ...
          links: [
            {
              title: "LinkedIn",
              url: "https://linkedin.com/in/kulkarni-kartikeya-4853691b8",
            },
          ],
        },
      ],
      ...
      members: [
        {
          ...
          links: [
            {
              title: "LinkedIn",
              url: "https://www.linkedin.com/in/rui-yuan-applicant/",
            },
            {
              title: "Google Scholar",
              url: "https://scholar.google.com/citations?user=h8_wSLkAAAAJ&hl=en",
            },
          ],
        },
        {
          ...
          links: [
            {
              title: "LinkedIn",
              url: "https://www.linkedin.com/in/donna-chen-1b245a19b/",
            },
            {
              title: "Google Scholar",
              url: "https://scholar.google.com/citations?user=3DTGyZ4AAAAJ&hl=en",
            },
          ],
        },
        {
          ...
          links: [
            {
              title: "LinkedIn",
              url: "https://www.linkedin.com/in/george-b-hanna/",
            },
            {
              title: "Google Scholar",
              url: "https://scholar.google.com/citations?user=h5c6DaEAAAAJ&hl=en",
            },
          ],
        },
        {
          ...
          links: [
            {
              title: "LinkedIn",
              url: "https://www.linkedin.com/in/devhjariwala",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          links: [
            {
              title: "LinkedIn",
              url: "https://www.linkedin.com/in/sudarshan-ganapathy-521a11241/",
            },
          ],
        },
        {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            A diverse, multi-level team advancing brain connectivity research
        ...
        <div className="mt-20">
          <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-lg p-8 text-center border border-orange-500/20">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              We're always looking for passionate researchers at all levels to
              join our mission of understanding brain connectivity. From high
              school students to postdocs, there's a place for you in our lab.
            </p>
